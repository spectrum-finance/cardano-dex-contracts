    ...
    pure $
        selfIdentity #&& (pmatch action $ \case
            ...
            _ -> unTermCont $ do
                ...
                let confPreserved = selfD #== succD -- config preserved
                ...
                let 
                    ...
                    valid = pmatch action $ \case
                        Swap ->
                            ...
                            liquidityLeftIntact = dlq #== 0 -- liquidity left intact
                            validSwap =
                        ...
                        ChangeStakingPool ->
                            poolCheckStakeChange # conf # txinfo'
                        
                        _ ->
                            validDepositRedeem = dlq * rx0 #<= dx * lq #&& dlq * ry0 #<= dy * lq0   
                            confPreserved #&& scriptPreserved #&& validDepositRedeem     
                pure valid
            )
